...
class Result:
    ...
    def __str__(self):
        return f"Best solution: {self._best} | Statistics: {self._statistics}"
    ...
    def plot_objectives(
        ...
        **kwargs: Dict[str, Any]
        ...
        ax.plot(self.statistics.objectives[:100], **kwargs)  # 이 부분에서 x 데이터 범위를 제한합니다.
        ax.plot(np.minimum.accumulate(self.statistics.objectives[:100]), **kwargs)
